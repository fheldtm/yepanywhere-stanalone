...
export const UI_KEYS = {
  ...
  codeFontFamily: "yep-anywhere-code-font-family",
  terminalTheme: "yep-anywhere-terminal-theme",
  tabSize: "yep-anywhere-tab-size",
  sidebarWidth: "yep-anywhere-sidebar-width",
  sidebarExpanded: "yep-anywhere-sidebar-expanded",
  sidebarTabsOpen: "yep-anywhere-sidebar-tabs-open",
  sidebarTasksOpen: "yep-anywhere-sidebar-tasks-open",
